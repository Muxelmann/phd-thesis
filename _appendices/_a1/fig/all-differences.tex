\begin{figure}\centering
	\includegraphics{foo} % \includegraphics{_chapter1/fig/minimising-substation-voltage-divergence}
	\caption{Cost function spread based on the ESMU schedule adjustment to minimise substation voltage deviation}
\end{figure}

\begin{figure}\centering
	\includegraphics{foo} % \includegraphics{_chapter1/fig/minimising-battery-voltage-divergence}
	\caption{Cost function spread based on the ESMU schedule adjustment to minimise ESMU's PCC voltage deviation}
\end{figure}

\begin{figure}\centering
	\includegraphics{foo} % \includegraphics{_chapter1/fig/minimising-maximum-voltage-divergence}
...
\begin{figure}\centering
	\includegraphics{foo} % \includegraphics{_chapter1/fig/minimising-phase-imbalance}
	\caption{Cost function spread based on the ESMU schedule adjustment to minimise the network's phase unbalance}
\end{figure}

\begin{figure}\centering
	\includegraphics{foo} % \includegraphics{_chapter1/fig/minimising-neutral-power}
...
\begin{figure}\centering
	\includegraphics{foo} % \includegraphics{_chapter1/fig/minimising-power-factor}
...
\begin{figure}\centering
	\includegraphics{foo} % \includegraphics{_chapter1/fig/minimising-substation-line-utilisation}
	\caption{Cost function spread based on the ESMU schedule adjustment to minimise the substation's fuse utilisation}
\end{figure}

\begin{figure}\centering
	\includegraphics{foo} % \includegraphics{_chapter1/fig/minimising-all-line-utilisation}
...
\begin{figure}\centering
	\includegraphics{foo} % \includegraphics{_chapter1/fig/minimising-losses}
