...
Since their availability (for example for PV installations) does not always align with periods of high demand (i.e. during morning and evening) arbitrage functions can be provided to maximise the use of renewable generation - i.e. renewables ``shifting'' \cite{Zakeri2015}.
...
\item
\textbf{Power quality}: In addition to the above-mentioned benefits, power electronics provided with the BESS can be used beneficially.
