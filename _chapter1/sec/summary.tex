...
Nonetheless, any cost minimisation always had an effect on different costs since \hlrem{e.g.} loss minimisation positively impacted nearly all other costs.
