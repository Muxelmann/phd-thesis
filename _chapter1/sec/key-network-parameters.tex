...
For $\zeta_{neutral\;\;load}(\textbf{s}_{ss}(t))$, each phase power, $s_{ss,p}(t)$, is therefore rotated by an integer multiple of $120^\circ$ before adding them to obtain the neutral load vector.
