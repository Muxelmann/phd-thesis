...
Experts would agree that keeping PF of a system close to unity indicates that it only requires active power to operate which implies that it uses the lowest possible amount of power transmission resources.
