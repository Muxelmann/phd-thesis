...
To put this into perspective, the losses in the IEEE LV Test Case network were 58kW, when simulated under the same high demand scenario which was used for voltage drop visualisation in Section \ref{ch1:subsec:voltages-related-cost-functions}.
...
Since this is a high network load, losses would be noticeably lower for normal network operation.
