...
\nomenclature{$v_{\text{ss},\phi}$}{Phase voltage at substation for phase $\phi$ at time $t$, where $v_{\text{ss},\phi}(t) \in \textbf{v}_{ss}(t)$ (Chapter \ref{ch1})}
\nomenclature{$\textbf{v}_{ss}(t)$}{Phase voltage vector at time $t$ (Chapter \ref{ch1})}
\nomenclature{$\phi$}{Phase number, typically $\phi \in [1, \dots, \Phi]$ (Chapter \ref{ch1})}
...
\nomenclature{$V_\text{ss}$}{Nominal substation voltage (Chapter \ref{ch1})}
...
\nomenclature{$v_{\text{ESMU},\phi}(t)$}{Phase voltage at ESMU for phase $\phi$ at time $t$, where $v_{\text{ESMU},\phi}(t) \in \textbf{v}_{ESMU}(t)$ (Chapter \ref{ch1})}
...
\nomenclature{$v_{\text{load},i,\phi}(t)$}{Phase voltage of load $i$ for phase $\phi$ at time $t$, where $v_{\text{load},i,\phi}(t) \in \textbf{v}_{load}(t)$ (Chapter \ref{ch1})}
...
\nomenclature{$s_{\text{ss},\phi}(t)$}{Apparent single-phase power at substation level for phase $\phi$ at time $t$, where $s_{\text{ss},\phi}(t) \in \textbf{s}_{ss}(t)$ (Chapter \ref{ch1})}
...
\nomenclature{$i_{\text{ss},\phi}(t)$}{Single-phase substation current for phase $\phi$ at time $t$ (Chapter \ref{ch1})}
