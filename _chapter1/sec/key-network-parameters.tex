...
In this chapter, Chapter~\ref{ch1}, of work, power flow simulations are run at discrete times, $t$, which are separated by a sampling period $\Delta t$. 
...
The following three subsections cover all key network parameters, by detailing the cost functions relating to: voltages, powers and currents.
