...
This equates to 12\% of the total network power, but losses would be noticeably lower during normal network operation, e.g. a maximum around 5\%.
...
Generally as the distance to the substation increases fewer ``down stream'' customers are connected to a radially expanding feeder and therefore cables can be scaled down (e.g. to save cost).
