...
As discussed in the future work in Chapter~\ref{ch-conclusions:sec:research-limits-and-future-work} a multi-objective problem may be considered as a next step where costs are weighted against each other.
