...
\nomenclature[I]{$\Delta t$}{High resolution sample period, i.e. sub-half hourly or minutely, where $\Delta t \in \mathbb{Z}_{>0}$ (Chapter \ref{ch1})}
...
\nomenclature[I]{$s_{\text{bat},\phi}(t)$}{Single-phase apparent battery power for phase $\phi$ at time $t$, where $(s_{\text{bat},\phi}(t)) = \textbf{s}_\text{bat}(t)$ and $s_{\text{bat},\phi}(t) \in \textbb{C}$ (Chapter \ref{ch1})}
