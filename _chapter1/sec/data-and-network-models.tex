...
\nomenclature[I]{$s_{\text{ESMU},\phi}(t)$}{Single-phase apparent ESMU power for phase $\phi$ at time $t$, where $(s_{\text{ESMU},\phi}(t)) = \textbf{s}_\text{ESMU}(t)$ and $s_{\text{ESMU},\phi}(t) \in \mathbb{C}$ (Chapter \ref{ch1})}
\nomenclature[I]{$\textbf{s}_\text{ESMU}(t)$}{Three-phase apparent ESMU power at time $t$, where $(s_{\text{ESMU},\phi}(t)) = \textbf{s}_\text{ESMU}(t)$ and $\textbf{s}_\text{ESMU}(t) \in \mathbb{C}^{\Phi}$ (Chapter \ref{ch1})}
...
\nomenclature[I]{$s^*_\text{net}(t)$}{Half-hourly network load, where $(s^*_\text{net}(t)) = \textbf{s}^*_\text{net}$ and $s^*_\text{net}(t) \in \mathbb{C}$ (Chapter \ref{ch1})}
