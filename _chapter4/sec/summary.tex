...
Although the improved algorithm only resulted in a comparable reduction of voltage variation (\hlrem{e.g.}\hladd{for example} voltage deviation was reduced by an average of 4\% when using AIMD and an average of 5\% when using AIMD+ in a scenario of 50\% BESS uptake), it did outperform AIMD when decreasing line utilisation, thus reducing the frequency of line overloads.
