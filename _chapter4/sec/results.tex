...
\begin{figure}\centering
 \subfloat[]{\includegraphics[width=0.5\textwidth]{foo}\label{subfig-voltage-AIMD1}}
 \subfloat[]{\includegraphics[width=0.5\textwidth]{foo}\label{subfig-voltage-AIMD2}}\vspace{-5pt}
...
\begin{figure}\centering
 \subfloat[]{\includegraphics[width=0.5\textwidth]{foo}\label{subfig-utilisation-AIMD1}}
 \subfloat[]{\includegraphics[width=0.5\textwidth]{foo}\label{subfig-utilisation-AIMD2}}
