...
\nomenclature[L]{$\text{SOC}_{min}$}{Minimum rated SOC for limited battery operation}
\nomenclature[L]{$\text{SOC}_{max}$}{Maximum rated SOC for limited battery operation}
\nomenclature[L]{$C$}{Battery capacity}
\nomenclature[L]{$P_{max}$}{Power rating of battery}
