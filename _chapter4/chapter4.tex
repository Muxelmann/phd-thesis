\chapter{Cooperative Battery Operation of without Needs for a Communication Infrastructure}
\label{ch4}
...
\input{_chapter4/sec/related-work}

\input{_chapter4/sec/system-modelling}

\input{_chapter4/sec/storage-control}

\input{_chapter4/sec/scenarios}

\input{_chapter4/sec/results}
