...
\begin{tikzpicture}[node distance=2cm, shorten >= 1pt, >=stealth', auto, scale=0.9, transform shape]
	...
	\draw [->] (1, 5) node[anchor=south] {$p_{net}(t)$} to [out=-135,in=135] (sam_0);
	\draw [->] (4, 5) node[anchor=south] {$p_{net}(t+\Delta t)$} to [out=-135,in=135] (sam_1);
	\draw [->] (7, 5) node[anchor=south] {$p_{net}(t+2\Delta t)$} to [out=-135,in=135] (sam_2);
	\draw [->] (10, 5) node[anchor=south] {$p_{net}(t+3\Delta t)$} to [out=-135,in=135] (sam_3);
	
	% Label the estimates
	\draw [->] (4, 0.75) node[anchor=north] {$\hat{p}_{net}(t+\Delta t)$} to [in=-45] (est_1);
	\draw [->] (7, 0.75) node[anchor=north] {$\hat{p}_{net}(t+2\Delta t)$} to [in=-45] (est_2);
	\draw [->] (10, 0.75) node[anchor=north] {$\hat{p}_{net}(t+3\Delta t)$} to [in=-45] (est_3);
...
%	\draw node[right of=legend_estimate, xshift=-15mm] {$\hat{p}_{net}$};
