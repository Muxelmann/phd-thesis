...
\caption{(\ref{ch2:subfig:traditional-forecast-based-system}) Traditional forecast driven BESS control; (\ref{ch2:subfig:traditional-on-line-system}) Traditional on-line system; (\ref{ch2:subfig:proposed-dynamic-control-system}) Proposed dynamic control system}
