...
Such a behaviour can be observed clearly during \hlrem{e.g.}\hladd{for example} days 6 and 25, where the half-hourly ESMU schedule increased the actual load peak by 2.8kW and 2.5kW, respectively.
