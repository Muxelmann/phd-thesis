...
\hl{The perfect foresight model (i.e. case \textbf{I}) performed only at 11.8\% and the MPC based cases (i.e. case \textbf{II}) achieved an average of 8.0\% probability of worsening the peak power.
