...
The resulting charging spike of more than 200kW could therefore cause significant issues if e.g. the underlying physical network has not been scaled appropriately.
