...
\hl{For the next iteration $n+1$ (for example Figure~}\ref{ch3:subfig:valley-filling-2}\hl{ where $n=2$) a proportion of the previously scheduled power vector $\textbf{p}^\text{EV}_{n-1}$ is ``undone''.
