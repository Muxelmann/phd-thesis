...
\include{_dedication/dedication}        % include a dedication.tex file
\include{_acknowlegements/acknowlegements}   % include an acknowledgements.tex file
\include{_abstract/abstract}          % include the abstract

\tableofcontents            % generate and include a table of contents
\listoffigures              % generate and include a list of figures
\include{_nomenclature/nomenclature}
