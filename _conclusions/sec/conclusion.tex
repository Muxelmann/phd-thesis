...
\hladd{The limitations of the presented research do however ask for future work to be conducted in order to ready the algorithms and methods for implementation by DNOs.
Beside the restrictions outlined in Section~}\ref{ch-conclusions:sec:research-limits}\hladd{ due to time constraints and targeted research focus that would require DNOs to further assess algorithm performance, stability and convergence, regulatory issues do need addressing, too.
For instance, the issue of ownership and possible means of incentivising customers to provide network support with their home-connected batteries is an task that needs to be tackled not only by academics, but also by DNOs, their customers and legislation makers.}
