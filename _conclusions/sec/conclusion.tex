...
This issue is particularly apparent when planning to generate bulk power at remote locations (\hlrem{e.g.}\hladd{for example} offshore) without having installed the required power lines.
